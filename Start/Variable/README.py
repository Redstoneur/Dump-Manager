from Start.Variable.package import *
from Start.Variable.Variable import PathFolderDumps, PathFileDatabaseInformation

README: str = """# Application : """ + package["name"] + """
...
To configure Dump-Manager, you need to implement the JSON-file `""" + PathFileDatabaseInformation + """`
...
To use Dump-Manager, you need to put dumps in the folder `""" + PathFolderDumps + """`
...
1. when the project was created
    ...
    - the project was created in the year """ + package["date-created"].split("-")[0] + """ by """ + package["author"][
    "firstName"] + " " + package["author"]["lastName"] + """
